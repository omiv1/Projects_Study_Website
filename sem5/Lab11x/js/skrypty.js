...
document.addEventListener('DOMContentLoaded', () => {
    ...
    kont.addEventListener("click", () =>
    {
       ...
       function pokazOnas() 
       {
        fetch("http://localhost/Lab11x/skrypty/onas.php")
            .then((response) => {
       ...
       function pokazGalerie() {
            fetch("http://localhost/Lab11x/skrypty/galeria.php")
                .then((response) => {
                     if (response.status !== 200) {
                         return Promise.reject('Coś poszło nie tak!');
                      }
       ...
       {
        fetch("http://localhost/Lab11x/skrypty/formularz.php")
        .then((response) => {
             if (response.status !== 200) {
                 return Promise.reject('Coś poszło nie tak!');
              }
        ...
        {
        fetch("http://localhost/Lab11x/skrypty/glowna2.php")
        .then((response) => {
            if (response.status !== 200) {
                return Promise.reject('Coś poszło nie tak!');
            }
