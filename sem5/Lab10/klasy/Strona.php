...
class Strona {
 ...
 protected $przyciski = array( "Kontakt" => "?strona=indexx", "Galeria" => "?strona=galeria", "Formularz" => "?strona=formularz", "O nas"=>"?strona=onas");
 ...
 echo "<div id='tresc'>";
 echo "<div id='nag'>";
 echo "<img src='zdjecia/baner.jpg' alt='foto' /></div>";
 echo "<div id='menu'>";
 $this->wyswietl_menu();
 echo "</div></div>";
 echo "<div id='main'>";
