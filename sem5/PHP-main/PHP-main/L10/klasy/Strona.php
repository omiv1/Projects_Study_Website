...
class Strona {
    ...
    protected $przyciski = array( "Kontakt" => "?strona=index","Galeria" => "?strona=galeria","Formularz" => "?strona=formularz","O nas"=>"?strona=onas");
 ...
 public function wyswietl() 
 {
    ...
    public function wyswietl_zawartosc() 
    {
        ...
        echo '<img src="'.$zdjecie.'" style="height: 150px; width: 1200px; "  />';
        echo "<div id='menu'>";
        $this->wyswietl_menu();
        echo "</div></div>";
        echo "<div id='main'>";
