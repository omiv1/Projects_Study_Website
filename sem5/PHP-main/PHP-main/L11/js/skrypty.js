...
document.addEventListener('DOMContentLoaded', () => {
    ...
    kont.addEventListener("click", () =>
    {
       ...
       function pokazOnas() 
       {
        fetch("http://localhost/PHP-main/PHP-main/L11/skrypty/onas.php")
            .then((response) => {
       ...
       function pokazGalerie() {
            fetch("http://localhost/PHP-main/PHP-main/L11/skrypty/galeria.php")
                .then((response) => {
                     if (response.status !== 200) {
                         return Promise.reject('Coś poszło nie tak!');
                      }
       ...
       {
        fetch("http://localhost/PHP-main/PHP-main/L11/skrypty/formularz.php")
        .then((response) => {
             if (response.status !== 200) {
                 return Promise.reject('Coś poszło nie tak!');
              }
        ...
        {
        fetch("http://localhost/PHP-main/PHP-main/L11/skrypty/glowna2.php")
        .then((response) => {
            if (response.status !== 200) {
                return Promise.reject('Coś poszło nie tak!');
            }
