...
<body>
    ...
    <form action="pliki.php" method="GET">
        ...
        <br/>
        <input type="radio" name="przegladarka" value="Eurocard" /> eurocard 
        <input type="radio" name="przegladarka" value="Visa" /> visa 
        <input type="radio" name="przegladarka" value="Przelew bankowy" />
        przelew bankowy<br />
