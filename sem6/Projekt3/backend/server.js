...
app.use('/api/charts', tokenVerification, chartRoutes);
app.use('/api/projects', tokenVerification, projectRoutes);

app.get('/api/load-projects', tokenVerification, async (req, res) => {
    try {
        let page = 1;
...
app.get('/api/locations', tokenVerification, async (req, res) => {
    try {
...
app.get('/api/measures', tokenVerification, async (req, res) => {
    try {
...
app.get('/api/getType', tokenVerification, async (req, res) => {
    try {
...
app.get('/api/type', tokenVerification, async (req, res) => {
    try {
